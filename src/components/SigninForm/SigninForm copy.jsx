...
function SigninForm() {
    ...
    return (
        <>
            <div className='top-4 h-[70vh] md:h-[90vh] relative w-full'>
                <Image
                    src={homeBanner}
                    alt="Background"
                    layout="fill"
                        ...
                        <div className="form-section flex justify-center md:justify-end items-end mt-8 md:mt-0">
                            <div className="w-full max-w-xs sm:max-w-sm md:max-w-lg p-4 sm:p-8  space-y-6 rounded-md">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between gap-4">
                                    <button className="w-full py-2 px-4 border border-gray-300 rounded-md flex justify-center items-center text-sm hover:bg-gray-50">
                                        <FcGoogle size={28} />
                                        Signup with Google
                                    </button>
                                    <button className="w-full py-2 px-4 border border-gray-300 rounded-md flex justify-center items-center text-sm hover:bg-gray-50">
                                ...
                                <div className="text-center text-gray-500">Or with email</div>
                                <form className="space-y-4 sm:space-y-2 xl:space-y-6">
                                    ...
                                    <div className="relative">
                                        <input type="password" placeholder="Password" className="w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                                    ...
                                    <button type="submit" className="w-full py-3 px-4 bg-green-500 text-white rounded-md hover:bg-green-600">
                                        Sign Up
                                    </button>
                                </form>
