  ...
  return (
    <>
      <div className='top-4 h-[70vh] sm:h-[80vh] md:h-[30vh] lg:h-[80vh] xl:h-[80vh] 2xl:h-[90vh] 3xl:h-[90vh] relative w-full'>
        ...
        <div className="absolute top-8 lg:top-32 text-3xl 3xl:top-32 md:text-2xl xl:text-[40px] 2xl:text-5xl 3xl:text-6xl font-bold left-[7vw] leading-[118%] sm:left-[10vw] md:left-[7vw] md:w-[32vw] 2xl:w-[35vw] xl:w-[38vw] 3xl:w-[35vw] scroll-element">
        ...
        <div className="absolute bottom-5 md:bottom-16 2xl:bottom-36 xl:bottom-32 3xl:bottom-48 text-xs xl:text-sm  2xl:text-lg leading-[158%] left-32 sm:left-[7vw] md:left-[24vw] xl:left-[20vw] 2xl:left-[18vw]  3xl:left-[18vw] scroll-element">
          <a href="https://asmuser.securethread.io/signup" target="_blank" rel="noopener noreferrer">
            <button className="bg-transparent hover:bg-green-800 text-green-500 font-semibold hover:text-white py-2 px-4 border border-gray-400 hover:border-transparent rounded-md md:w-28 xl:w-40 2xl:w-50">
              Signup
            </button>
          </a>
        </div>
