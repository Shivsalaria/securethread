  ...
  return (
    <>
      ...
      <div className='top-8 h-[70vh] sm:h-[80vh] md:h-[30vh] lg:h-[80vh] xl:h-[80vh] 2xl:h-[90vh] 3xl:h-[90vh] relative w-full'>
        ...
        <div className="absolute text-lg bottom-[40vh] xs:bottom-[45vh] md:text-sm md:bottom-36 xl:bottom-64 2xl:bottom-72 3xl:bottom-96  xl:text-lg 2xl:text-lg left-[7vw] leading-[158%] sm:left-[7vw] md:left-[7vw] md:w-[35vw] xl:w-[38vw] 2xl:w-[35vw] 3xl:w-[32w] scroll-element">
        ...
        <div className="absolute bottom-12 md:bottom-16 2xl:bottom-36 xl:bottom-32 3xl:bottom-48 text-xs xl:text-sm  2xl:text-lg left-[7vw] leading-[158%] sm:left-[7vw] md:left-[7vw] xl:left-20 2xl:left-32 3xl:left-[7vw] scroll-element">
        ...
        <div className="absolute bottom-12 md:bottom-16 2xl:bottom-36 xl:bottom-32 3xl:bottom-48 text-xs xl:text-sm  2xl:text-lg leading-[158%] left-32 sm:left-[7vw] md:left-[24vw] xl:left-[20vw] 2xl:left-[18vw]  3xl:left-[18vw] scroll-element">
      ...
      <div className="absolute xs:top-[23rem] top-80 md:top-48 lg:top-52 lg:left-[57vw] sm:left-[10vw] md:left-[47vw] xl:left-[45vw] scroll-element">
